...
mod tests {
    ...
    fn it_tokenizes_close_tag() {
        ...
        assert_eq!(result.tokens.len(), 1, "Tokenized {:?}", result.tokens);
    ...
    fn it_tokenizes_element_with_comment() {
        ...
        assert_eq!(res.errors.len(), 0, "Errors: {:?}", res.errors);
        assert_eq!(res.tokens.len(), 8, "Tokenized {:?}", res.tokens);
    }
...
<body>
   <!-- This is a comment in Html. -->
        ...
        assert_eq!(res.errors.len(), 0, "Errors: {:?}", res.errors);
        assert_eq!(res.tokens.len(), 14, "Tokenized {:?}", res.tokens);
    }
