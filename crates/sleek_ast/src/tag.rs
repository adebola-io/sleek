...
impl Display for HtmlTag {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            "{}",
            match self {
                HtmlTag::DocType => "doctype",
                HtmlTag::A => "a",
                HtmlTag::Abbr => "abbr",
                HtmlTag::Acronym => "acronym",
                HtmlTag::Address => "address",
                HtmlTag::AltGlyph => "altGlyph",
                HtmlTag::AltGlyphRef => "altGlyphRef",
                HtmlTag::AltGlyphItem => "altGlyphItem",
